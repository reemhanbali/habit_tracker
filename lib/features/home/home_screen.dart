...
import 'package:habits_tracker_app/core/widgets/calendar_days_list.dart';
import 'package:habits_tracker_app/core/widgets/date_picker.dart';
      ...
      body: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            CalendarDaysList(
              days: getDatesWithinRange(getWeekRange(DateTime.now())),
            ),
